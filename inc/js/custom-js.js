...
function preview_images() 
{
 ...
 {
  $('#image_preview').append("<div class='col-md-3'><img class='img-responsive img-prev' src='"+URL.createObjectURL(event.target.files[i])+"'></div>");
 }
}
		...
		var button = $(this),
			...
			/* loop through all the images */
				...
				if( !in_array( attachments[i].id, hiddenfieldvalue ) ) {
					...
					$('ul.misha_gallery_mtb').append('<li data-id="' + attachments[i].id + '" class="gallery-item"><img src="' + attachments[i].attributes.url + '" height="100" width="100"></span><a href="#" class="misha_gallery_remove">×</a></li>');
